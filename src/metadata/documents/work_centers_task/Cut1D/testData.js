...
export const nom = job_prm.nom.profile;
const cuts = [1711, 1920, 2058, 4768];
...
export const record_kind = enm.debit_credit_kinds.credit;

obj.fillDefault = function () {
  obj.cuts.clear();
  obj.cutting.clear();
  for(const len of cuts) {
    obj.cuts.add({record_kind, nom, len});
  }
