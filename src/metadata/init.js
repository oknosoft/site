...
class CatUsersИдентификаторыRow extends TabularSectionRow{
get identifier(){return this._getter('identifier')}
set identifier(v){this._setter('identifier',v)}
get Сервер(){return this._getter('Сервер')}
set Сервер(v){this._setter('Сервер',v)}
}
$p.CatUsersИдентификаторыRow = CatUsersИдентификаторыRow;
class CatUsersАбонентыRow extends TabularSectionRow{
get Абонент(){return this._getter('Абонент')}
set Абонент(v){this._setter('Абонент',v)}
get branch(){return this._getter('branch')}
set branch(v){this._setter('branch',v)}
get Роли(){return this._getter('Роли')}
set Роли(v){this._setter('Роли',v)}
}
$p.CatUsersАбонентыRow = CatUsersАбонентыRow;
